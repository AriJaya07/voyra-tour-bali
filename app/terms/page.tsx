      ...
      <Container>
        <div className="max-w-3xl mx-auto py-14 sm:py-20">
          ...
          <SectionBlock number="1" title="Acceptance of Terms">
            <p>
              These Terms & Conditions govern your use of <strong>Bali Travel Now</strong> (balitravelnow.com), operated by <strong>I Made Ari Jaya Kusuma</strong>, an individual travel service provider based in Bali, Indonesia. By visiting our website, creating an account, or making a booking, you confirm that you have read, understood, and agree to these terms.
            </p>
          </SectionBlock>
