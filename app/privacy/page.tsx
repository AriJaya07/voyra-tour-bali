      ...
      <Container>
        <div className="max-w-3xl mx-auto py-14 sm:py-20">
          ...
          <SectionBlock number="1" title="Who We Are">
            <p>
              <strong>Bali Travel Now</strong> (balitravelnow.com) is a travel service provider based in Bali, Indonesia. We operate an online platform where travelers can discover, browse, and book tours and activities across Bali. For the purposes of data protection law, Bali Travel Now is the data controller responsible for your personal information.
            </p>
          </SectionBlock>
