...
// ── Icon imports ──────────────────────────────────────────────────────────────
import OverviewIcon     from "../../assets/Icon/sidebar/OverviewIcon";
import CategoriesIcon   from "../../assets/Icon/sidebar/CategoriesIcon";
import DestinationsIcon from "../../assets/Icon/sidebar/DestinationsIcon";
import PackagesIcon     from "../../assets/Icon/sidebar/PackagesIcon";
import LocationsIcon    from "../../assets/Icon/sidebar/LocationsIcon";
import BookingsIcon     from "../../assets/Icon/sidebar/BookingsIcon";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className={`flex items-center justify-between pb-5 px-4 border-b border-slate-700/60 ${collapsed ? "px-3 justify-center" : ""}`}>
        <div className="flex items-center gap-3 min-w-0">
          <Link href={"/"} target="_self" className="w-8 h-8 rounded-xl bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center flex-shrink-0 shadow-lg shadow-violet-900/40">
            <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
