      ...
      {isMockMode ? (
        <div className="mt-4 space-y-4">
          <div className="p-5 bg-[#F8F8F8] rounded-xl border border-gray-200">
            ...
            {!date && (
              <div className="mb-2 text-[11px] font-semibold text-red-500 flex items-center gap-1.5 animate-pulse">
            ...
            <a
              ...
              className={`w-full h-12 text-white font-bold text-sm rounded-xl transition-all shadow-sm flex items-center justify-center gap-2.5 ${
                date 
